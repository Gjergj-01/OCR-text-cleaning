...
file_path = 'datasets/sharegpt-format-datasets/training_dataset.json'
...
def subwords(messy, clean):
    ...
    if not common_words:  # <-- Aggiungi questo blocco
...
with open("datasets/sharegpt-format-datasets/new_training_dataset.json", "w") as out:
